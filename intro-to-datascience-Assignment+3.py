...
def answer_one():
    ...
    GDP = GDP[np.append(['Country Name'],years)]
    GDP.reset_index()
...
def answer_four():
    ...
    Top15['sixthGDP'] = Top15['2015'] - Top15['2006']
    Top15 = Top15.reset_index() 
    return Top15.loc[5, 'sixthGDP']
...
def answer_six():
    Top15 = answer_one()
    answer = Top15['% Renewable'].argmax()
    return (answer, Top15.loc[answer, '% Renewable'])
answer_six()
...
def answer_ten():
    ...
    Top15['HighRenew'] = Top15['% Renewable'] >= Top15['median']
